...
**The Cat Whistle** — iron, string and a Cat Treat. One press and every tamed
cat within a hundred blocks comes to you. Cats wander further than you think.

**The Yarn Ball** — three string, sixteen to a stack. Throw it the way you
throw an egg: she chases it down, bats it around, brings it back — and she is
in a better mood for it, which matters now that hunger wears her mood down.

**The Cat Show** — craft a Show Podium, stand a tamed cat on it, and a judge
scores her out of a hundred: her outfits, her mood, whether she is well fed,
her health, whether she is grown. The breakdown is printed line by line.
Ninety or more wins **Best in Show**, a trophy you cannot craft, only win.
